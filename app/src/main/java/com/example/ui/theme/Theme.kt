...
private val DarkColorScheme =
  darkColorScheme(
    ...
    secondary = DarkProfessionalSecondary,
    onSecondary = DarkProfessionalOnSecondary,
    secondaryContainer = DarkProfessionalSecondaryContainer,
    onSecondaryContainer = DarkProfessionalOnSecondaryContainer,
    background = DarkProfessionalBackground,
    onBackground = DarkProfessionalOnBackground,
    surface = DarkProfessionalSurface,
    onSurface = DarkProfessionalOnSurface,
    surfaceVariant = DarkProfessionalSurfaceVariant,
    onSurfaceVariant = DarkProfessionalOnSurfaceVariant,
  )
